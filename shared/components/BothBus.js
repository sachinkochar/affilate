...
export default class BothBus extends Component {
  render() {
    let opt = [
        {
            class: "grey-text",
                ...
                <section className="mt-3 wow fadeIn">
                    <div className="row">
                        <div className="col-md-12 mb-4">
                            <h2 className="text-center base-text py-4 mb-4">Both Business</h2>
                                ...
                                <div className="card-body mt-5">
                                    <form>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6 mb-4">
                                                <InputText type="text" id="defaultFormCardNameEx" class="form-control" />
                                                <Label for="defaultFormCardNameEx" class="base-text font-weight-light" text="Bussiness Website"/>
                                            </div>
                                            <div className="col-md-6 mb-4">
                                                <Select selectClass="form-control" opt={opt} />
                                                <Label class="base-text font-weight-light" text="Offline Bussiness Address"/>
                                            </div>
                                        </div>
                                        <br/>
                                        <div className="row">
