        ...
        _proto._setListeners = function _setListeners() {
          ...
          triggers.forEach((trigger) => {
            if (trigger === 'click') {
              ...
              $$$1(_this3.element)
                .on(eventIn, _this3.config.selector, event => _this3._enter(event))
    ...
    const ScrollSpy =
      ...
      (function () {
        function ScrollSpy(element, config) {
          ...
          this._config = this._getConfig(config);
          this._selector = `${this._config.target} ${Selector.NAV_LINKS},${this._config
            .target} ${Selector.LIST_ITEMS},${this._config.target} ${Selector.DROPDOWN_ITEMS}`;
          this._offsets = [];
          this._targets = [];
